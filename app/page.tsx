...
export default async function Home() {
  ...
  {[
    ...
    { title: "Compatible MT5 & Prop Firms", desc: "Fonctionne nativement sur MetaTrader 5 et compatible avec les principales prop firms.", link: "/guide-qrypton/prop-firm" },
  ].map((f, i) => (
