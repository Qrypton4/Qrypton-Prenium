...
export default function PathCard({
  ...
  return (
    ...
    >
      {recommended && (
        <span className="absolute top-4 right-4 px-3.5 py-1.5 rounded-full text-[10px] font-mono uppercase tracking-wide bg-blue/15 text-blue-soft border border-blue-soft/30 shadow-sm">
          Recommandé
        </span>
      )}
